...
enum {KA_NONE, KA_NEXT, KA_PREV, KA_ICONIFY, KA_ICONIFY_ALL, KA_MAXIMISE, KA_EXPAND, KA_CLOSE, KA_TITLE, KA_TOPLEFT, KA_TOPRIGHT, KA_BOTTOMRIGHT, KA_BOTTOMLEFT, KA_EXEC};
